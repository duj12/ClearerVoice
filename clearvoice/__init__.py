...
class ClearVoice:
    ...
    """
    def __init__(self, task, model_names, checkpoint_path):
        ...
        checkpint_path:
            the user defined model ckpt, default is at current_dir/checkpoint
        ...
        for model_name in model_names:
            model = self.network_wrapper(task, model_name, checkpoint_path)
            self.models += [model]  
